...
@:keep @:bind #if display private #end class __ASSET__assets_gd1_project_tilemap1_tmx extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_gd1_tileset_image_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
